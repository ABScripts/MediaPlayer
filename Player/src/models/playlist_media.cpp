...
void PlaylistMedia::setMockData()
{
//    m_Playlist = new PlaylistElement("TestPlaylist");

//    std::vector<Composition> *compositions = new std::vector<Composition>;

//    compositions->emplace_back("none", "SongTest1", "Pop", QDate(2, 2, 2002));
//    compositions->emplace_back("none", "SongTest2", "Pop", QDate(2, 2, 2002));
//    compositions->emplace_back("none", "SongTest3", "Pop", QDate(2, 2, 2002));
//    compositions->emplace_back("none", "SongTest4", "Pop", QDate(2, 2, 2002));
//    compositions->emplace_back("none", "SongTest5", "Pop", QDate(2, 2, 2002));
