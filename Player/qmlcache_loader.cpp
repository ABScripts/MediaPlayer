...
namespace _qml_playlistMediaView_qml { 
    extern const unsigned char qmlData[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), nullptr, nullptr
    };
...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/qml/playlistMediaView.qml"), &QmlCacheGeneratedCode::_qml_playlistMediaView_qml::unit);
